...
class Main
{
    ...
    //0. What do we call types like double, int, float, boolean, byte and short? Primitive data types.
		...
		//calculations
		tax = price * TAX_RATE;     // 6. What value is stored into the variable tax? The product of 0.15 and user input 

		total = price + tax;     //7. What value is stored into the variable total? The sum of price and tax.
